...
public class CropTextures : MonoBehaviour
{
    ...
    //Criar as possíveis posições para que as peças possam ser instanciadas
    ...
    //Sorteando aleatoriamente sempre uma nova posição para a peça que está sendo instanciada
    ...
    //Instanciar as peças na cena que irão representar as partes da textura recortada
    void CreadPiece()
    {
    ...
    //Metodo para cortar a imagem em pedaços
    ...
    //Criação de um grid que vai estar integrado as peças
